...
import { Link } from 'react-router-dom';       // Link es suficiente; no necesita navigate()
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(URL_LOGIN, { email, password }, {
        // ⚠️ IMPORTANTE: withCredentials = true para que el navegador
        //    guarde la httpOnly cookie que envía el servidor.
